...
| _Desarroladores_ | _Equipo de personas que se dedican a progamar la aplicación_ | _Llegar a desarrollar la aplicación en su totalidad segun los deseas del cliente_
| _Usuario final_ | _Aquella persoan o conjunto de personas que van a emplear la applicación_ | _Una aplicación completa que genere ningún problema a la hora de su empleo y que además sea facil de usar_ 
|===
