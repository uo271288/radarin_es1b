...
| _Desarroladores_ | _Equipo de personas que se dedican a progamar la aplicación_ | _ Llegar a desarrollar la aplicación en su totalidad segun los deseas del cliente_
