...
|Cliente | Representante del cliente que desea desarrollar la apliación | EL seguiniemto del desarrolo de la aplicación para que esta se ajuste lo máximo posible a sus expectativas. Tambien nos da las directrices que desea que se gestionen en la aplicación 
