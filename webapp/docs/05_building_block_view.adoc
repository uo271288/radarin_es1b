...
| _POD_ | _Almacena toda la información de la aplicación_
|===
...
_Es la parte de la aplicación que se comunicará directamente con el usuario, mostrando su información y la de sus amigos cercanos.
